...
func main() {
    ...
    s.AddPrompt(
        mcp.NewPrompt("analyze_logs",
            ...
            mcp.WithPromptArgument("log_level",
                mcp.Description("Minimum log level to analyze"),
                mcp.Default("error"),
            ),
        ),
        handleAnalyzeLogs,
...
func handleConfig(ctx context.Context, req mcp.ReadResourceRequest) (*mcp.ReadResourceResult, error) {
