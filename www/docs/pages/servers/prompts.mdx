...
func handleCodeReview(ctx context.Context, req mcp.GetPromptRequest) (*mcp.GetPromptResult, error) {
    ...
    language := getStringArg(req.Params.Arguments, "language", "auto-detect")
    focus := getStringArg(req.Params.Arguments, "focus", "all")
    ...
    return &mcp.GetPromptResult{
        ...
        Messages: []mcp.PromptMessage{
            {
                Role: "user",
                Content: mcp.TextContent(fmt.Sprintf(`Please review the following %s code:
...
func handleDataAnalysis(ctx context.Context, req mcp.GetPromptRequest) (*mcp.GetPromptResult, error) {
    ...
    return &mcp.GetPromptResult{
        ...
        Messages: []mcp.PromptMessage{
            {
                Role: "user",
                Content: mcp.TextContent(fmt.Sprintf(`%s
...
func handleFlexiblePrompt(ctx context.Context, req mcp.GetPromptRequest) (*mcp.GetPromptResult, error) {
    ...
    return &mcp.GetPromptResult{
        ...
        Messages: []mcp.PromptMessage{
            {
                Role: "user",
                Content: mcp.TextContent(prompt),
            },
        },
    }, nil
}
...
func handleConversationPrompt(ctx context.Context, req mcp.GetPromptRequest) (*mcp.GetPromptResult, error) {
    ...
    case "customer_support":
        messages = []mcp.PromptMessage{
            {
                Role: "system",
                Content: mcp.TextContent("You are a helpful customer support representative. Be polite, professional, and solution-oriented."),
            },
            {
                Role: "user",
                Content: mcp.TextContent(fmt.Sprintf("I'm a %s with a question about your service.", userRole)),
            },
            {
                Role: "assistant", 
                Content: mcp.TextContent("Hello! I'm here to help. What can I assist you with today?"),
            },
            {
                Role: "user",
                Content: mcp.TextContent("Please continue the conversation based on the customer's needs."),
            },
        }
    ...
    case "technical_interview":
        messages = []mcp.PromptMessage{
            {
                Role: "system",
                Content: mcp.TextContent("You are conducting a technical interview. Ask thoughtful questions and provide constructive feedback."),
            },
            {
                Role: "user",
                Content: mcp.TextContent("Let's begin the technical interview. Please start with an appropriate question."),
            },
        }
    }
...
func handleRoleBasedPrompt(ctx context.Context, req mcp.GetPromptRequest) (*mcp.GetPromptResult, error) {
    ...
    messages := []mcp.PromptMessage{
        {
            Role: "system",
            Content: mcp.TextContent(systemMessage),
        },
    }
    ...
    if context != "" {
        messages = append(messages, mcp.PromptMessage{
            Role: "user",
            Content: mcp.TextContent(fmt.Sprintf("Context: %s", context)),
        })
    }
...
func handleDynamicResourcePrompt(ctx context.Context, req mcp.GetPromptRequest) (*mcp.GetPromptResult, error) {
    ...
    return &mcp.GetPromptResult{
        ...
        Messages: []mcp.PromptMessage{
            {
                Role: "user",
                Content: mcp.TextContent(content.String()),
            },
        },
    }, nil
}
...
func handleConditionalPrompt(ctx context.Context, req mcp.GetPromptRequest) (*mcp.GetPromptResult, error) {
    ...
    return &mcp.GetPromptResult{
        ...
        Messages: []mcp.PromptMessage{
            {
                Role: "user",
                Content: mcp.TextContent(prompt.String()),
            },
        },
    }, nil
}
...
func handleTemplatePrompt(ctx context.Context, req mcp.GetPromptRequest) (*mcp.GetPromptResult, error) {
    ...
    return &mcp.GetPromptResult{
        ...
        Messages: []mcp.PromptMessage{
            {
                Role: "user",
                Content: mcp.TextContent(content),
            },
        },
    }, nil
}
