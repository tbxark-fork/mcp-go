...
### Resource Design
- Use clear, hierarchical URIs (`docs://api/endpoints` not `doc1`)
- Implement proper MIME types for content
...
### Transport Selection
- **Stdio**: Default choice for most applications
- **HTTP**: When you need REST-like access or load balancing
- **SSE**: When you need real-time updates or web integration
